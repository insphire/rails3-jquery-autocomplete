...
(function(jQuery)
{
  ...
  jQuery.railsAutocomplete.fn.extend({
    init: function(e) {
      ...
      function reset_input_elements(e) {
        jQuery(jQuery(e).attr('data-id-element')).val("");
        if (jQuery(e).attr('data-update-elements')) {
          var update_elements = jQuery.parseJSON(jQuery(e).attr("data-update-elements"));
      ...
      jQuery(e).autocomplete({
        ...
        change: function(event, ui) {
          // if value has changed but no valid item selected, reset everything to blank
          if (ui.item == null) {
            reset_input_elements(this);
            this.value = "";
          }
        },
